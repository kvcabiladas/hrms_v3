    ...
    <div class="max-w-2xl mx-auto mt-10 bg-white rounded-xl shadow-lg border border-green-200 overflow-hidden">
        ...
        <div class="p-8 space-y-6">
            ...
            <div class="text-center pb-6 border-b border-gray-100">
                ...
                <div class="mt-2">
                    <span
                        class="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-xs font-mono font-bold">{{ $employee_id }}</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg flex justify-between items-center border border-gray-200">
                    ...
                    <button onclick="copyToClipboard('{{ $username }}')"
                        class="text-gray-600 hover:text-green-600 transition" title="Copy username">
                ...
                <div class="bg-yellow-50 p-4 rounded-lg flex justify-between items-center border border-yellow-200">
                    ...
                    <button onclick="copyToClipboard('{{ $access_code }}')"
                        class="text-yellow-600 hover:text-yellow-800 transition" title="Copy access code">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z">
                            </path>
            ...
            <div class="text-center pt-4">
                <a href="{{ route('superadmin.dashboard') }}"
                    class="block w-full py-3 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition">
                    Return to Dashboard
                </a>
            </div>
        </div>
