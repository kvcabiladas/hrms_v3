                    ...
                    <form :action="action === 'terminate' ? '{{ route('employees.update', $employee->id) }}' : '{{ route('employees.update', $employee->id) }}'" method="POST">
                        ...
                        <div class="space-y-4">
                            ...
                            <div x-data="{ showPassword: false }">
                                ...
                                <div class="relative">
                                    <input :type="showPassword ? 'text' : 'password'" name="access_code" required maxlength="8" pattern="\d{8}"
                                        class="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:border-green-500 focus:outline-none"
