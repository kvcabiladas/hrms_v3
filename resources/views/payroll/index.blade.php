...
@section('content')
    <div class="flex justify-end mb-6 gap-3">
        ...
        <!-- Only Accountants or Super Admin can see these buttons -->
        @php
            $isAccountant = Auth::user()->employee && 
                            Auth::user()->employee->designation && 
                            Auth::user()->employee->designation->name === 'Accountant';
        @endphp

        @if(Auth::user()->role === 'super_admin' || $isAccountant)
            <!-- Settings Button -->
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <table class="w-full text-left text-sm text-gray-600">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-6 py-8 text-center text-gray-500">No payroll records found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
