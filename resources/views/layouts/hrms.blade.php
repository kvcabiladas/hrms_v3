    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden bg-gray-50">
            ...
            <header class="bg-white border-b border-gray-200 flex items-center justify-between px-6 h-16 z-10">
                ...
                <!-- Profile Dropdown -->
                <div class="relative" x-data="{ open: false, showNotifications: false }">
                    <button @click="open = !open" @click.outside="open = false"
                        class="flex items-center gap-3 focus:outline-none relative">
                        ...
                        <div
                            class="h-10 w-10 rounded-full bg-green-100 text-green-600 flex items-center justify-center font-bold text-lg border-2 border-white shadow-sm cursor-pointer hover:bg-green-200 transition relative">
                            {{ substr(Auth::user()->name, 0, 1) }}
                            @if(auth()->user()->unreadNotifications()->count() > 0)
                                <span
                                    class="absolute -top-0.5 -right-0.5 w-3 h-3 bg-red-500 rounded-full border-2 border-white"></span>
                            @endif
                        </div>
                    </button>
                    <div x-show="open"
                        class="absolute right-0 mt-2 w-80 bg-white rounded-md shadow-lg border border-gray-100 z-50 overflow-hidden"
                        style="display: none;">
                        ...
                        <div class="border-b border-gray-100">
                            <button @click.stop="showNotifications = !showNotifications"
                                ...
                                <svg class="w-4 h-4 text-gray-400 transition-transform"
                                    :class="showNotifications ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start gap-2">
                                            <div class="flex-shrink-0 mt-0.5">
                                                ...
                                                @else
                                                    <div
                                                        class="w-6 h-6 bg-gray-100 text-gray-600 rounded-full flex items-center justify-center">
                                                        <svg class="w-3 h-3" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                        ...
                        <a href="{{ route('settings.index') }}"
                            class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 flex items-center gap-2 transition">
