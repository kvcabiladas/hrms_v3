            ...
            <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                ...
                @if(Auth::user()->role === 'super_admin')
                    <div class="mb-6 pb-6">
                        ...
                        <a href="{{ route('settings.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('settings.*') ? 'bg-purple-50 text-purple-700 font-medium' : 'text-gray-600 hover:bg-gray-50' }}">
                ...
                @else
                    ...
                    <a href="{{ route('leaves.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('leaves.*') ? 'bg-green-50 text-green-700 font-medium' : 'text-gray-600 hover:bg-gray-50' }}"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg><span>Leave Management</span></a>
                    
                    <!-- PAYROLL (Dynamic Label) -->
                    <a href="{{ route('payroll.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('payroll.*') ? 'bg-green-50 text-green-700 font-medium' : 'text-gray-600 hover:bg-gray-50' }}">
                        ...
                        <span>{{ Auth::user()->role === 'employee' ? 'My Payroll' : 'Payroll' }}</span>
                    </a>
